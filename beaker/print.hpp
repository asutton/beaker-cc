...
std::ostream& operator<<(std::ostream&, Short_Integer_type const&);
std::ostream& operator<<(std::ostream&, Long_Integer_type const&);
std::ostream& operator<<(std::ostream&, Integer16_type const&);
std::ostream& operator<<(std::ostream&, Integer32_type const&);
std::ostream& operator<<(std::ostream&, Integer64_type const&);
std::ostream& operator<<(std::ostream&, Integer128_type const&);
