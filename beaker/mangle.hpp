...
void mangle(std::ostream&, Short_Integer_type const*);
void mangle(std::ostream&, Long_Integer_type const*);
void mangle(std::ostream&, Integer16_type const*);
void mangle(std::ostream&, Integer32_type const*);
void mangle(std::ostream&, Integer64_type const*);
void mangle(std::ostream&, Integer128_type const*);
